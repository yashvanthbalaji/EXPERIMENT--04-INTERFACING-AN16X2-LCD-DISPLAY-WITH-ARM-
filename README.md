...
int main(void){
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "BALAJI.A");
    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212223040023");
        HAL_Delay(500);
  while (1){}}
void SystemClock_Config(void){
...
![Screenshot 2024-11-18 145725](https://github.com/user-attachments/assets/167ccec7-8c28-4a55-aa93-c18524a1f83f)
